...
public class Notificacion1Controller implements IObserver {
    ...
    public void actualizar(int cantidad, String nombre, String codigo) {
        ...
        if (cantidad <= 0) {
            labelCliente.setTextFill(Color.RED);
            labelCliente.setText("Producto fuera de stock");
        } else {
            labelCliente.setTextFill(Color.BLACK);
            labelCliente.setText("Producto en stock");
        }
    }
}
